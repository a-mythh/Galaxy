...
class MainWidget(RelativeLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # does not give the correct size of the window
        self.init_audio()
    ...
    def init_audio(self):
        ...
        self.sound_music1 = SoundLoader.load("audio/Grieg - In the Hall of the Mountain King.wav")
        self.sound_restart = SoundLoader.load("audio/restart.wav")

        # volume of audio is in percent
    ...
    def on_size(self, *args):
        ...
        # gives the correct size of the window
        # self.perspective_point_x = self.width / 2
        # self.perspective_point_y = self.height * 3 / 4
        # we can also use kv file for the above
        # self.update_vertical_lines()
        # so that the line's position is changed everytime the window is resized
    ...
    def init_vertical_lines(self):
        with self.canvas:
            ...
            # this does not work as the window size is not updated
    ...
    def update(self, dt):
        # print("dt: " + str(dt * 60) + " - 1/60: " + str(1/60))
        time_factor = dt * 60
        self.update_vertical_lines()
        self.update_horizontal_lines()
        self.update_tiles()
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            while self.current_offset_y >= spacing_y:
                ...
                print("current_offset_y: " + str(self.current_offset_y))
